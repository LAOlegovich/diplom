# Generated by Django 5.0.2 on 2024-03-14 19:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('house', models.CharField(blank=True, max_length=10)),
                ('flat', models.PositiveSmallIntegerField(blank=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users_addresses', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_params', to='backend.parameter', verbose_name='Параметр')),
                ('product_position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_params', to='backend.product_positions', verbose_name='инфа о позиции продукции')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='params',
            field=models.ManyToManyField(through='backend.ProductParams', to='backend.parameter'),
        ),
        migrations.CreateModel(
            name='Shop',
            fields=[
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('product_position', 'parameter'), name='unic_prod_param'),
        ),
    ]
